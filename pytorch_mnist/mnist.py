...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='Net', metavar='MD',
                        help='model (default: Net (with 2 conv layers), alternative: [Net, Net2(with 3 conv layers)])')
    parser.add_argument('--adam_lr', type=float, default=0.001, metavar='ALR',
                        help='learning rate for adam (default: 0.001)')
    parser.add_argument('--sgd_lr', type=float, default=0.01, metavar='SLR',
