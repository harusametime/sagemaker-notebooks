...
if __name__=='__main__':
    ...
    valid_data = np.load(os.path.join(args.valid, 'valid.npz'))['images']
    valid_labels = np.load(os.path.join(args.valid, 'valid.npz'))['labels']

    train = chainer.datasets.TupleDataset(train_data, train_labels)
    valid = chainer.datasets.TupleDataset(valid_data, valid_labels)
    ...
    valid_iter = chainer.iterators.SerialIterator(valid, args.batch_size,
    ...
    # Evaluate the model with the valid dataset for each epoch
